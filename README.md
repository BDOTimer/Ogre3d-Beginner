...
> [!CAUTION]
> - Перед открытием проекта выполнить `extract assimp.exe`.
...
10. :black_circle: **Задача: иметь соглашение на ВНЕШНИЙ ИНТЕРФЕЙС для всех участников.**
...
- :black_circle: **Задача: перечислить все возможные модули для проекта. Пока только перечислить.**
---
