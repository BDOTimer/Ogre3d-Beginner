...
10. :cloud_with_lightning: **Задача: иметь соглашение на ВНЕШНИЙ ИНТЕРФЕЙС для всех участников.**
...
- :cloud_with_lightning: **Задача: перечислить все возможные модули для проекта. Пока только перечислить.**
---
